...
.pill-red{background:#fee2e2;color:#b91c1c}.pill-orange{background:#ffedd5;color:#c2410c}.pill-yellow{background:#fef9c3;color:#a16207}.pill-green{background:#dcfce7;color:#15803d}
...
var MATRIX = {
  B:{1:'Conversa formal — Líder',2:'Conversa formal + Advert. Verbal',3:'Restrição 03 dias + Advert. formal + Reciclagem',x:'Comitê pela Vida'},
  M:{1:'Advertência Verbal',2:'Reciclagem + Advertência formal',3:'Restrição 05 dias + Advert. formal + Reciclagem',x:'Comitê pela Vida'},
  G:{1:'Reciclagem + Advertência formal',2:'Restrição 03 dias + Advert. formal + Reciclagem',3:'Comitê pela Vida',x:'Comitê pela Vida'},
  GV:{1:'Restrição 03 dias + Advert. formal + Reciclagem',2:'Restrição 05 dias + Advert. formal + Reciclagem',3:'Comitê pela Vida',x:'Comitê pela Vida'}
};
...
function getSevLabel(s){if(s==='GV')return '<span class="pill pill-red">Gravíssima</span>';if(s==='G')return '<span class="pill pill-orange">Grave</span>';if(s==='M')return '<span class="pill pill-yellow">Média</span>';return '<span class="pill pill-green">Baixa</span>';}
...
function renderAll(){
  ...
  var custo=(totalB*0.04+totalM*0.10+totalG*0.18+totalGV*0.30)*6.50;
...
<div class="main">
  ...
  <div class="content">
    ...
    <div class="kpi-row">
      ...
      <div class="kpi blue"><div class="kpi-lbl">Custo Extra Est.</div><div class="kpi-val" id="k-custo">—</div><div class="kpi-sub">combustível desperdiçado (R$ 6,50/L)</div></div>
